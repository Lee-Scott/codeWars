...
public class SolutionTest {
    ...
    public void sampleTests() {
        ...
        assertEquals("Test for (a1, c1)", 2, ChessTwo.knight("a1", "c1"));
        assertEquals("Test for (a1, f1)", 3, ChessTwo.knight("a1", "f1"));
        assertEquals("Test for (a1, f3)", 3, ChessTwo.knight("a1", "f3"));
        assertEquals("Test for (a1, f4)", 4, ChessTwo.knight("a1", "f4"));
        assertEquals("Test for (a1, f7)", 5, ChessTwo.knight("a1", "f7"));
    }
}